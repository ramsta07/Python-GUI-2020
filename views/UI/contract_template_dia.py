...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.leSourceFolder.setClearButtonEnabled(True)
        ...
        self.leOutputFolder.setClearButtonEnabled(True)
        ...
        self.radioDebit = QtWidgets.QRadioButton(self.groupBox_2)
        self.radioDebit.setMaximumSize(QtCore.QSize(16777214, 16777215))
        self.radioDebit.setChecked(True)
        self.radioDebit.setObjectName("radioDebit")
        self.buttonGroup = QtWidgets.QButtonGroup(Dialog)
        self.buttonGroup.setObjectName("buttonGroup")
        self.buttonGroup.addButton(self.radioDebit)
        self.horizontalLayout.addWidget(self.radioDebit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioDebit.setText(_translate("Dialog", "Debit"))
